...
PeyBoard_alpha.prototype.generateLettersLayout = function(upperCase) {
    ...
    letterLayout.push("<div class = 'keyboardRow'>");
    letterLayout.push("<div onclick = upperCase(false); class = 'keyboardKey" + (upperCase ? ' shiftKeyActive\' ' : '\' ')+ dynamicStyle +">" + "^" + "</div>");
    ...
    letterLayout.push("<div class = 'keyboardKey' "+ dynamicStyle +" onclick='removeLetter()'>" + "<=" + "</div>");
    letterLayout.push("</div>");
